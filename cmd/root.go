...
import (
	...
	"github.com/gkwa/itsfilmnoir/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.itsfilmnoir.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".itsfilmnoir")
	}
